...
//			ergebnisse[spieltag.current_matchday][i % numberOfMatchesPerMatchday][i / numberOfMatchesPerMatchday] = Integer.parseInt(spieltag.tore[i].getText());
			setErgebnis(spieltag.current_matchday, i % numberOfMatchesPerMatchday, i / numberOfMatchesPerMatchday, Integer.parseInt(spieltag.tore[i].getText()));
		}
		int counter = 0;
...
//	                    this.ergebnisse[counter][match][1] = toreAWAY;
	                    ...
	                    setErgebnis(counter, match, 0, toreHOME);
	                    setErgebnis(counter, match, 1, toreAWAY);
...
//					element += ergebnisse[i][j][0] + ":" + ergebnisse[i][j][1] + ";";
					...
					element += getErgebnis(i, j, 0) + ":" + getErgebnis(i, j, 1) + ";";
				}
			}
