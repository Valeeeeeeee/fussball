...
public class Mannschaft {
    ...
    public Mannschaft(int i, int anzahl_spieltage) {
    	id = i;
    	daten = new int[anzahl_spieltage][4];
    	homeaway = new boolean[anzahl_spieltage];
    	positiononplan = new int[anzahl_spieltage];
    }
    ...
    public void setGegner(int matchday, int homeoraway, int opponent, int spielnummer) {
    	...
    	this.positiononplan[matchday] = Start.ligen[Start.aktuelle_liga].getAnzahlSpiele() * (homeoraway - HOME) + spielnummer;
    }
